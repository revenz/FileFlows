...
public class LibraryHandler(FrontendService feService)
{
    ...
    /// </summary>
    public event Action<Dictionary<Guid, string>> LibraryListUpdated; 
    ...
    public void Initialize(InitialClientData data)
    {
        ...
        feService.Registry.Register<Dictionary<Guid, string>>(nameof(LibraryList), (ed) =>
        {
            LibraryList = ed;
            LibraryListUpdated?.Invoke(ed);
        });
    }
}